...
\subsection{Memorándums interdepartamentales}
	...
	%Se describe a continuación el sistema que el CMPL ha implementado como una medida para mitigar el impacto en la calidad del trabajo del CMPL y su compromiso con el medio ambiente.\\
	...
	%Existen algunos sistemas que cuentan con ciertas características y funcionalidades requeridas para algunas de las actividades mencionadas anteriormente.\\
...
%\begin{itemize}
%	\item TTR259 “Sistema Web para la Gestión y Control de la Correspondencia Interna en la Escuela Superior de Cómputo. GECO I”.
%	\item TTR260 “Sistema Web para la Gestión y Control de la Correspondencia de Oficios en la Escuela Superior de Cómputo”.
%	\item SIADOC. Software genérico de licencia para manejo de correspondencia.
%\end{itemize}
