...
\section{Actividades del CMPL}
	...
	La figura \ref{fig:OficiosEntrantes} muestra cómo es el proceso de recepción de oficios externos al CMPL y cómo es que éstos son atendidos.
	...
	\subsubsection{Oficios de respuesta y salientes}
	La figura \ref{fig:OficiosRespuesta} muestra cómo es el proceso de elaboración, evaluación y envío de oficios externos de respuesta de CMPL.
	
	\begin{figure}[htbp!]
		\centering
			\includegraphics[width=1\textwidth]{images/antecedentes/respondeoficio.png}
