\section{Diagramas de Casos de Uso}
	...
	\begin{UseCase}{CU1}{Iniciar Sesión}{
		...
		Si el personal ingresa mal su nombre de usuario y/o contraseña mostrará mensaje en pantalla "Correo institucional y/o contraseña incorrectos. Intento de nuevo."}
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Solicita iniciar sesión presionando el botón  \IUref{UI1}{Pantalla de Control de Acceso}\label{CU17Login}.
		...
		\UCpaso[\UCactor] Selecciona el Seminario en el que desea inscribirse \Trayref{B}
			...
			\begin{itemize}
				\item Trayectoria principal:
					\begin{enumerate}
						...
						\item La aplicación muestra la pantalla \IUref{35}, con una tabla que muestra por departamento el directorio interno del CMPL por nombre completo, cargo, extensión y correo electrónico.
					\end{enumerate}
			\end{itemize}
