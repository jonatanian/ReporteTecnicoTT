...
Para fines de este proyecto sólo se considerará la confiabilidad, la disponibilidad, la robustes y la seguridad debido a que realizar un sistema con todas las propiedades no funcionales resulta muy complejo y requeriria mucho tiempo para lograse, además de que el CMPL no requiere que lleve todas las propiedades porque el sistema es sólo para operarse dentro del centro. A continuación se define cada una de ellas. \\ %poner un porque acertivo 
...
Con respecto a los atributos mencionados, se considera que el servidor se deberá encontrar en buenas condiciones... 
