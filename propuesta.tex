...
Este modulo permitirá el registro, la consulta, los cambios y la eliminación de usuarios; además permitirá el control de acceso a la aplicación para que los usuarios puedan hacer uso de la aplicación. \\
...
\subsubsection{Modulo 2: Correspondencia}
...
%\subsection{Modulo 3: Correspondencia Interna}
